...
class FSCameraView: UIView, UIGestureRecognizerDelegate {
    ...
    convenience init() {
        ...
        flashButton.setImage(#imageLiteral(resourceName: "yp_iconFlash_on"), for: .normal)
        flipButton.setImage(#imageLiteral(resourceName: "yp_iconLoop"), for: .normal)
        shotButton.setImage(#imageLiteral(resourceName: "yp_iconCapture"), for: .normal)
    }
}
