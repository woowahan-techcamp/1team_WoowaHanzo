document.addEventListener("DOMContentLoaded", function(event) {
  ...
  $(".nav_signin_btn").on("mousedown touchstart", function(evt) {
    evt.preventDefault();
  ...
  $("#post").on("mousedown touchstart", function(evt) {
    evt.preventDefault();
    window.location.href = "post.html";
  });

  $("#ranking").on("mousedown touchstart", function(evt) {
    evt.preventDefault();
  ...
  firebase.auth().onAuthStateChanged(function(user) {
    if (user) {
      ...
      currentUsername.on('value', function(snapshot) {
        ...
        $(".nav_user_info").on("mousedown touchstart", function(evt) {
          evt.preventDefault();
